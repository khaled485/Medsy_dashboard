            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form action="{{ route('dashboard.clients.orders.create',$client->id) }}" method="get">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                @if ($category->products->count() > 0)
                                                    <form action="{{ route('dashboard.clients.orders.create',$client->id) }}" method="get">
                                                        <div class="row" style="margin-bottom: 10PX">
                                                            <div class="col-md-6">
                                                                <input type="text" name="search_products" class="form-control" placeholder="@lang('site.search_products')" value="{{ request()->search_products }}">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> @lang('site.search')</button>
